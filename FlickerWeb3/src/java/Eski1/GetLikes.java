...
import static Eski1.GetComment.loadXMLFromString;
    ...
    public void islemyap() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String link = "http://api.flickr.com/services/rest/?method=flickr.favorites.getPublicList&api_key=36181890d2a8d522b684205020251321&user_id="+PhotoOwnerId+"&extras=owner_name&per_page=1000000&format=rest";
