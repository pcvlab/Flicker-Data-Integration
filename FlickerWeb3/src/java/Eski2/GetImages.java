...
public class GetImages {
    ...
    public void allprocess(String generalpath) {
        //        for (int i = 500; i < 1600; i++) { createnewfolder(i+""); }
    ...
    public void downloadimages() {
        ...
        try {
            ...
            int sayac = 0;
            rs = st.executeQuery("Select url_o,ID,PHOTOID FROM photos WHERE downimage=0 and ID>500000");
            int id;
            String folderpath = "1";
            String photoid;
            String link;
            ...
            while (rs.next()) {
                ...
                if (link.length() > 10) {
                    ...
                    if (sayac % 50 == 0) {
                        ...
                        settextinf(id + " -  Elli download yapildi");
                        break;
    ...
    public void createnewfolder(String foldername) {
        try {
            File newDir = new File("/Volumes/AhmetM/Flicker/" + foldername);
