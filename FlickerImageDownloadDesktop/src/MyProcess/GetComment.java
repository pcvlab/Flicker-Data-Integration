...
import static MyProcess.GetComment.loadXMLFromString;
import static MyProcess.GetData.getCharacterDataFromElement;
import static MyProcess.GetData.loadXMLFromString;
...
//System.out.println("islemsayisi = " + sayac);
    ...
    public void getXMLtoSQL(int ID, String photo_id, Document xmlcomment) {
        ...
        Statement st = null;
            ...
            st = conn.createStatement();
              int basariligirdi=0;
              System.out.println("notes.getLength = " + nodes.getLength());
...
//              
                        ...
                        System.out.println("basariligirdi = " + basariligirdi);
